...
<body>
  ...
  <header class="top-header">
    <div class="container header-inner">
      <div class="logo">
        <a href="7"></a>
        <img src="../website/public/uploads/logo.jpg" alt="Logo da loja">
      </div>

      <nav class="main-nav">
        <ul>
          <li><a href="../website/">Início</a></li>
          <li><a href="../website/404.php">Sobre nós</a></li>
          <li><a href="../website/404.php">Contato</a></li>
        </ul>
      </nav>
      <div href="website/carrinho.php" class="header-icons">
        ...
        <a href="../website/backofice/login.php" class="contact-btn"><i class="fas fa-user"></i> Loja</a>
      </div>
    </div>
  </header>
