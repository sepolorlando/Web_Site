...
<head>
    ...
    <link rel="stylesheet" href="../../website/public/assets/css/login.css">
    <title>Login</title>
</head>
...
<body>
   <div class="login">
        <div class="logo"  >
          <img src="../../website/public/uploads/logo.png"  width="150" height="60"  alt="Logo da loja">
        </div>
        ...
        <p class="login-link">Ainda não tens conta? <a href="create_user.php">Criar uma conta</a></p>
    </div>
